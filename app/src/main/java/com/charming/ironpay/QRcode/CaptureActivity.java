package com.charming.ironpay.QRcode;
...
import com.charming.ironpay.QRcode.camera.CameraManager;
import com.charming.ironpay.QRcode.common.BitmapUtils;
import com.charming.ironpay.QRcode.decode.BitmapDecoder;
import com.charming.ironpay.QRcode.decode.CaptureActivityHandler;
import com.charming.ironpay.QRcode.view.ViewfinderView;
import com.charming.ironpay.R;
import com.charming.ironpay.card.CardListActivity;
import com.charming.ironpay.transfer.ConfirmActivity;
...
//        viewfinderView.drawResultBitmap(barcode);
        ...
        Toast.makeText(this,
                ...
                Toast.LENGTH_SHORT).show();
        Log.d("CaptureActivity", ResultParser.parseResult(rawResult).toString());

        try {
            JSONObject jsonObject = new JSONObject(ResultParser.parseResult(rawResult).toString());
            Log.d("CaptureActivity", jsonObject.toString());
            Intent intent = new Intent(CaptureActivity.this, ConfirmActivity.class);
//        Bundle bundle = new Bundle();
//        bundle.putString("from", "18868126465");
//        bundle.putString("to", ResultParser.parseResult(rawResult).toString());
//        bundle.putDouble("money",123.4);
//        intent.putExtra("bundle",bundle);
            intent.putExtra("money", jsonObject.getString("money"));
            intent.putExtra("sellerlist", jsonObject.getString("sellerlist"));
            intent.putExtra("to", "ironshop订单");
