...
import com.charming.ironpay.database.MyDatabaseHelper;
...
//    }
    ...
    private void Login() {
        ...
        client.post(MyApplication.getServer() + "/login", params, new AsyncHttpResponseHandler() {
                    @Override
                    public void onSuccess(int i, cz.msebera.android.httpclient.Header[] headers, byte[] bytes) {
                        ...
                        try {
                            ...
                            if (status.equals("error")) {
                                ...
                                startActivity(intent);
                                LoginActivity.this.finish();
                            } else if (status.equals("notexit")) {
                                Toast.makeText(LoginActivity.this, "不存在该账号，请先注册", Toast.LENGTH_LONG).show();
                            }
